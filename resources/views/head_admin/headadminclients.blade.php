        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Message Parent | <span id="messageName"></span></h1>
                </div>
...
<script>
    ...
    function loadParents() {
        $.ajax({
            type: "GET",
            url: "{{route('headAdmin.load.parents')}}",
            beforeSend: function() {
    ...
    function searchContacts(searchQuery) {
        $.ajax({
            type: 'GET',
            url: "{{ route('headAdmin.search.parent') }}",
            data: {
                query: searchQuery
            },
            beforeSend: function() {
