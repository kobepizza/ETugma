                ...
                <div class="col-12 col-md-5">
                    <div class="card collapsed shadow rounded-2 mt-2" id="chats">
                        ...
                        <div class="contacts collapse p-3" id="contactBody" data-bs-parent="#chats">
                            <div class="d-none row row-cols-auto gap-3 px-3 mb-3"> <!--filters-->
                                <div class="col">
...
<script>
    $(document).ready(function() {
        ...
        function loadNotifs() {
            $.ajax({
                type: 'GET',
                url: '{{ route("headadmin.load.notif") }}',
                beforeSend: function() {
        ...
        $('#notifList').on('click', '.notif-item', function() {
           ...
           // console.log('delete-value:', notifIdValue); // This should log the value of notifId
            ...
            function fetchNotifDetails() {
                $.ajax({
                    type: 'post',
                    url: '{{ route("headadmin.fetch.notif") }}',
                    data: {
                        notif_id: notifId,
                    ...
                    success: function(data) {
                        ...
                        function displayBookingNotif(data) {
                            ...
                            let details =
                                `
                                    ...
                                    <h5 class="fw-bold">From: ${author.toUpperCase()}</h5>
                                    <br>
                                    ...
                                    <h5 class="mb-5 guardian text-capitalize"><span class="fw-bold">Guardian:</span> ${guardian}</h5>
                            ...
                            let payment =
                                `
                                    <div class="d-flex flex-column align-items-center p-4" id="paymentBtn">
                                        ...
                                        <a href="https://google.com" class="btn d-md-w-25  payment " role="button">Payments</a>
                                    </div>
                                    `;
                        ...
                        function displaySystemNotif(data) {
                            ...
                            if (title == "A Parent sent you a message" || title == "A Tutor sent you a message") {
                                userMessage = true;
                            }
                            ...
                            let link =
                                `
                                   <div class="d-flex flex-column align-items-center p-4 mt-5" id="paymentBtn">
                                        <h5 class="mb-3">Proceed to <span class="fw-bold">Manage Parents</span> or <span class="fw-bold">Manage Tutors</span> for further actions.</h5>
                                        <div class="hstack gap-2 align-items-center justify-content-center">
                                            <a href="{{route('headAdmin.parent')}}" class="btn d-md-w-25  payment " role="button">Manage Parents</a>
                                            <a href="{{route('headAdmin.tutor')}}" class="btn d-md-w-25  payment " role="button">Manage Tutors</a>
                                        </div>
                                    </div>
                                `;
        ...
        $('#deleteNotification').on('submit', function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('headadmin.delete.notif') }}",
                data: {
