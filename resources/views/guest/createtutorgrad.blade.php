    ...
    <div class="register container growable-flex px-4 py-5">
        <div class="vstack gap-1">
            <div class="hstack gap-1">
                <p class="ms-auto">Are you an undergraduate?</p>
                <a class="link" href="{{route('signup.undertutor')}}">
                    <p>Sign Up as an Undergrad Tutor</p>
                </a>
            </div>
            <div class="hstack gap-1">
        ...
        <main>
            <div class="container col-auto shadow-lg rounded-4 p-3">
                <form action="{{route('signup.gradtutor')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    @endforeach
                    @endif
                    <input type="hidden" name="educlvl" value="Graduate"><!--education level-->
                    <div class="container d-fluid">
                        <h2 class=" display-6 fw-normal mt-5 mb-5 text-center">Sign Up as a Tutor</h2>
                            ...
                            <div class="row ">
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="input-group flex-nowrap mb-3"> <!--first name-->
                                        ...
                                        <input type="text" name="gradFname" class="form-control" value="{{old('gradFname')}}" placeholder="First name" onfocus="(placeholder='ex. Juan')" onblur="(placeholder='First name')" required>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <label class="d-flex align-items-center">
                                    ...
                                    <div class="input-group flex-nowrap mb-3"> <!--last name-->
                                        ...
                                        <input type="text" name="gradLname" class="form-control" value="{{old('gradLname')}}" placeholder="Last name" onfocus="(placeholder='ex. Dela Cruz')" onblur="(placeholder='Last name')" required>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <label class="d-flex align-items-center">
                                    ...
                                    <div class="input-group mb-3"> <!--sex-->
                                        ...
                                        <select name="gradGender" class="form-select" required>
                                            <option value="" selected disabled>Select Gender</option>
                                            @foreach ($gender as $data)
                                            <option value="{{ $data->id }}" {{old('gradGender') == $data->id ? 'selected' : ''}}>{{ $data->gender }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="input-group flex-nowrap mb-3"> <!--bday-->
                                        ...
                                        <input type="date" id="bdayinput"  name="gradBday" value="{{old('gradBday')}}" class="form-control" aria-describedby="addon-wrapping" required>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <label class="d-flex align-items-center">
                                    ...
                                    <div class="input-group flex-nowrap mb-3"> <!--country-->
                                        ...
                                        <input type="text" name="gradCountry" class="form-control" placeholder="Country" value="{{old('gradCountry')}}" onfocus="(placeholder='ex. Philippines')" onblur="(placeholder='Country')" required>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <label class="d-flex align-items-center">
                                    ...
                                    <div class="input-group flex-nowrap mb-3"> <!--municipality-->
                                        ...
                                        <input type="text" name="gradCity" class="form-control" value="{{old('gradCity')}}" placeholder="Municipality" onfocus="(placeholder='ex. Makati City')" onblur="(placeholder='Municipality')" required>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <label class="d-flex align-items-center">
                                    ...
                                    <div class="input-group flex-nowrap mb-3"> <!--address-->
                                        ...
                                        <input type="text" name="gradAddress" class="form-control" value="{{old('gradAddress')}}" placeholder="Address " onfocus="(placeholder='Blk,Lot,Street')" onblur="(placeholder='Address')" required>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <label class="d-flex align-items-center">
                                    ...
                                    <div class="input-group flex-nowrap mb-3"> <!--cp num-->
                                        ...
                                        <input type="text" name="gradCpNum" min="0" maxlength="11" value="{{old('gradCpNum')}}" class="form-control" placeholder="Mobile Number" onfocus="(placeholder='ex. 09123456789')" onblur="(placeholder='Mobile Number')" required>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <label class="d-flex align-items-center">
                                    ...
                                    <div class="input-group flex-nowrap mb-3"> <!--email-->
                                        ...
                                        <input type="email" name="gradEmail" value="{{old('gradEmail')}}" class="form-control" placeholder="Work email" required>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <label class="d-flex align-items-center">
                                    ...
                                    <div class="input-group flex-nowrap mb-3"> <!--password-->
                                        ...
                                        <input type="password" minlength="8" name="gradPassword" class="form-control border-end-0" onblur="passwordBlur()" onfocus="passwordFocus()" placeholder="Password" id="password-input" required>
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="input-group flex-nowrap mb-3"> <!--confirm password-->
                                        ...
                                        <input type="password" minlength="8" name="gradConfirm" class="form-control" placeholder="Confirm Password" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-md-6">
                                    <label class="d-flex align-items-center">
                                        <h7>School Graduated</h7><span style="color:red;">*</span>
                                    </label>
                                    <div class="input-group flex-nowrap mb-3"> <!--school attended-->
                                        <span class="input-group-text" id="addon-wrapping"><svg class="bi" width="20" height="20">
                                                <use xlink:href="#school" />
                                            </svg></span>
                                        <input type="text" name="gradSchool" class="form-control" value="{{old('gradSchool')}}" placeholder="School" required>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <label class="d-flex align-items-center">
                                        <h7>Year Graduated</h7><span style="color:red;">*</span>
                                    </label>
                                    <div class="input-group flex-nowrap mb-3"> <!--year graduated-->
                                        <span class="input-group-text" id="addon-wrapping"><svg class="bi" width="20" height="20">
                                                <use xlink:href="#yearlvl" />
                                            </svg></span>
                                        <input type="text" name="gradYear" maxlength="4" class="form-control" value="{{old('gradYear')}}" placeholder="Year Graduated" onfocus="(placeholder='ex. 2010')" onblur="(placeholder='Year Graduated')" required>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <label class="d-flex align-items-center">
                                        <h7>Degree</h7><span style="color:red;">*</span>
                                    </label>
                                    <div class="input-group flex-nowrap mb-3"> <!-- Degree-->
                                        <span class="input-group-text" id="addon-wrapping"><svg class="bi" width="20" height="20">
                                                <use xlink:href="#yearlvl" />
                                            </svg></span>
                                        <input type="text" name="degree" class="form-control" value="{{old('degree')}}" placeholder="Degree" onfocus="(placeholder='ex. Bachelor of Science in Informtion Technology')" onblur="(placeholder='Degree')" required>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <label class="d-flex align-items-center gap-1">
                                        <h7>Upload TOR<span style="color:red;">*</span></h7><span class="fw-light fst-italic fs-6">Accepted document formats: .pdf</span>
                                    </label>
                                    <div class="input-group flex-nowrap mb-3"> <!-- TOR-->
                                        <span class="input-group-text" id="addon-wrapping"><svg class="bi" width="20" height="20">
                                                <use xlink:href="#file" />
                                            </svg></span>
                                        <input type="file" name="gradTor" class="form-control" accept="application/pdf" required>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <label class="d-flex align-items-center gap-1">
                                        <h7>Upload Diploma<span style="color:red;">*</span></h7><span class="fw-light fst-italic fs-6">Accepted document formats: .pdf</span>
                                    </label>
                                    <div class="input-group flex-nowrap mb-3"> <!--Diploma-->
                                        <span class="input-group-text" id="addon-wrapping"><svg class="bi" width="20" height="20">
                                                <use xlink:href="#file" />
                                            </svg></span>
                                        <input type="file" name="diploma" class="form-control" accept="application/pdf" required>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <label class="d-flex align-items-center gap-1">
                                    ...
                                    <div class="input-group flex-nowrap mb-3"> <!-- Resume-->
                                        ...
                                        <input type="file" name="gradResume" class="form-control" accept="application/pdf" required>
                                    </div>
                                </div>
                                <hr class="col-12 mb-3 mt-3">
                                </hr>
                                <div class="col-12 col-md-6">
                                    <label class="d-flex align-items-center">
                                        <h7>Select Employment Type</h7><span style="color:red;">*</span>
                                    </label>
                                    <div class="input-group mb-3"> <!--valid id-->
                                        ...
                                        <select name="employment" class="form-select" required>
                                            ...
                                            <option value="{{ $data->id  }}" {{ old('employment') == $data->id ? 'selected' : '' }}>{{ $data->type}}</option>
                                            @endforeach
                                            <option disabled>Note: Full-Time employees can teach for monthly sessions, while Part-Time employees can only teach for hourly sessions</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="input-group mb-3"> <!--valid id-->
                                        ...
                                        <select name="gradValid" class="form-select" required>
                                            <option value="" selected disabled>Select Valid ID</option>
                                            @foreach ($valid as $data)
                                            <option value="{{ $data->id }}" {{ old('gradValid') == $data->id ? 'selected' : '' }}>{{ $data->type }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="input-group flex-nowrap mb-3"> <!-- valid id num-->
                                        ...
                                        <input type="text" name="gradValidNum" maxlength="20" id="validnum" class="form-control" value="{{ old('gradValidNum')}}" placeholder="Valid ID Number" required>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <label class="d-flex align-items-center gap-1">
                                    ...
                                    <div class="input-group flex-nowrap mb-3"> <!-- upload valid id-->
                                        ...
                                        <input type="file" name="gradUploadValid" accept="application/pdf" class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <label class="d-flex align-items-center">
                                        <h7>PRC ID Number (optional)</h7>
                                    </label>
                                    <div class="input-group flex-nowrap mb-3"> <!-- PRC ID num-->
                                        <span class="input-group-text" id="addon-wrapping"><svg class="bi" width="20" height="20">
                                                <use xlink:href="#lrn" />
                                            </svg></span>
                                        <input type="text" name="prcNum" value="{{ old('prcNum')}}" maxlength="7" id="PRCnum" class="form-control" placeholder="PRC ID Number">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <label class="d-flex align-items-center gap-1">
                                        <h7>Upload PRC ID (optional)</h7><span class="fw-light fst-italic fs-6">Accepted document formats: .pdf</span>
                                    </label>
                                    <div class="input-group flex-nowrap mb-3"> <!-- upload valid id-->
                                        <span class="input-group-text" id="addon-wrapping"><svg class="bi" width="20" height="20">
                                                <use xlink:href="#lrn" />
                                            </svg></span>
                                        <input type="file" name="uploadPrc" class="form-control" accept="application/pdf">
                                    </div>
                                </div>
                                <div class="col-12">
