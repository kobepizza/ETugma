...
<script>
    $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $.each(data, function(index, contact) {
                        var html = '';
                        html += '<button class="list-group-item list-group-item-action contact-item" aria-current="true" type="button" tutor-id="' + contact.id + '" user-type-id="' + contact.user_type_id + '">';
        ...
        $('#contactList').on('click', '.contact-item', function() {
            ...
            userTypeId = $(this).attr('user-type-id');

            //console.log('active:', activeContact, 'usertype:', userTypeId);
            ...
            let channelName;
            if (userTypeId == 4) {
                channelName = 'headAdmin-' + receiverId + '-admin-' + parentId + '-chat';
            } else if (userTypeId == 3) {
                let ids = [receiverId, parentId];
                ids.sort();
                channelName = 'adminReceiver-' + ids[0] + '-adminSender-' + ids[1] + '-chat';
            }
           ...
           // console.log('Subscribed to:', channelName);
            ...
            currentChannel.bind('admin-chat', function(data) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    response.messages.forEach(function(message) {
                        ...
                        let userAvatar = isSender ? "{{ asset(session('user_profiles')->profile_pic) }}" : profileImage;
        ...
        function searchContacts(searchQuery) {
            $.ajax({
                type: 'GET',
                url: "{{ route('admin.search.contacts') }}",
                data: {
                    query: searchQuery
                },
                beforeSend: function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.success) {
                            ...
                            let userAvatar = "{{ asset(session('user_profiles')->profile_pic) }}";
