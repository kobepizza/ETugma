    ...
    <div class="modal fade" tabindex="-1" id="changeprofile" data-bs-backdrop="static">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="POST" action="{{route('admin.profileEdit')}}" enctype="multipart/form-data">
                    @csrf
            ...
            <section class="mb-4">
                <div class="vstack gap-2 d-flex align-items-center w-100">
                    ...
                    <span class="d-flex align-items-center justify-content-center">
                        ...
                        <h1 class="fw-bold">{{ strtoupper(session('adminMain')->fname) . ' ' . strtoupper(session('adminMain')->lname) ?? 'N/A' }}</h1>
                    </span> <!--Tutor full name-->
                    <h3>{{ session('adminMain')->userType->type  ?? 'N/A' }}</h3><!---Employment type-->
                </div>
            </section>
            <!---->
            <!--body-->
                                    ...
                                    <li class="list-group-item">
                                        <div class="data-container d-flex align-items-center p-2">
                                            ...
                                            <div class="col col-lg-7">
                                                <span class="fs-5 data-value">{{ ucwords(strtolower(session('adminMain')->fname)) . ' ' . ucwords(strtolower(session('adminMain')->lname)) ?? 'N/A' }}</span> <!--session type-->
                                            </div>
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <div class="data-container d-flex align-items-center p-2">
                                            ...
                                            <div class="col col-lg-7">
                                                <span class="fs-5 data-value">{{ ucwords(strtolower(session('adminMain')->email))  ?? 'N/A' }}</span> <!--department-->
                                            </div>
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <div class="data-container d-flex align-items-center p-2">
                                            ...
                                            <div class="col col-lg-7">
                                                <span class="fs-5 data-value">{{ ucwords(strtolower(session('adminMain')->contact_num))  ?? 'N/A' }}</span> <!--Subject-->
                                            </div>
                                        </div>
                                    </li>
                                </ul>
