    ...
    <div class="offcanvas-body">
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-item {{ $page == 'Dashboard' ? 'active' : '' }}">
                <a href="{{ route('parent.dashboard') }}" class="sidebar-link"> <!--dashboard button-->
            ...
            <li class="sidebar-item {{ $page == 'Profile' ? 'active' : '' }}">
                <a href="{{route('parent.profile')}}" class="sidebar-link"> <!--profile button-->
                    <svg class="bi" width="20" height="20" fill="currentcolor">
                        <use xlink:href="#user" />
                    </svg>
                    Profile
            ...
            <li class="sidebar-item {{ $page == 'Find Tutor' ? 'active' : '' }}">
                <a href="{{route('parent.find.tutor')}}" class="sidebar-link"> <!--library system redirect button-->
                    <svg class="bi" width="20" height="20" fill="currentcolor">
                        <use xlink:href="#find" />
                    </svg>
                    Find Tutor
            ...
            <li class="sidebar-item {{ $page == 'Assessments' ? 'active' : '' }}">
                <a href="{{route('parent.assessments')}}" class="sidebar-link"> <!--assessments button-->
                    <svg class="bi" width="20" height="20" fill="currentcolor">
            ...
            <li class="sidebar-item {{ $page == 'Messages' ? 'active' : '' }}">
                <a href="{{route('parent.message')}}" class="sidebar-link"> <!--library system redirect button-->
                    <svg class="bi" width="20" height="20" fill="currentcolor">
                        <use xlink:href="#msg" />
                    </svg>
                    Messages
            ...
            <li class="sidebar-item {{ $page == 'Notifications' ? 'active' : '' }}">
                <a href="{{route('parent.notif')}}" class="sidebar-link"> <!--library system redirect button-->
                    <svg class="bi" width="20" height="20" fill="currentcolor">
            ...
            <li class="sidebar-item {{ $page == 'Transactions' ? 'active' : '' }}">
                <a href="{{route('parent.transaction')}}" class="sidebar-link"> <!--library system redirect button-->
                    <svg class="bi" width="20" height="20" fill="currentcolor">
...
<script>
    $(document).ready(function() {
        //console.log('count function ready');
